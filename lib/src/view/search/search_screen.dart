...
import 'package:aflami/components/after_hero.dart';
...
import 'package:aflami/src/view/search/providers/search_film_provider.dart';
import 'package:aflami/utils/assets_manager.dart';
import 'package:aflami/utils/debouncer.dart';
              ...
              slivers: [
                ...
                SliverToBoxAdapter(
                  child: state.maybeWhen(
                    ...
                    orElse: () => Center(
                      child: Text(
                        'قم بالبحث عن طريق اسم الفلم او المسلسل',
                      ),
                    ),
                  ),
                )
